...
CounterButton=GUI_Classes.Main_Button(window, font=("Helvetica",40),command=lambda:GUI_Classes.SwitchGUI(root, MainGUI, MenuGUI, 10, True))
...
MenuGUI.add_Element(AlarmNow, 0,1,1,1)
MenuGUI.add_Element(AlarmPlusAnHour, 1,1,1,1)
MenuGUI.add_Element(Alarmplus1day, 2,1,1,1)
...
def Alarmconfirmed(MainButton):
    ...
    MainButton.config(command=lambda:GUI_Classes.SwitchGUI(root, MainGUI, MenuGUI, 10, True))
...
counter_Button(MainGUI.Elements[0])
